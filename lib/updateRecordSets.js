...
var findInstanceIPs = function () {
    throw new Error('deprecated');
};

var instancePublicIp = function (instance) {
    return instance.PublicIpAddress;
};

var instancePrivateIp = function (instance) {
    return instance.PrivateIpAddress;
};


var instancePublicIPs = function (filters, privateIP, region) {
